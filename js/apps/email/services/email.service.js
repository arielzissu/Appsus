...
// console.log('2',txt)
// let serchedBooks
// serchedBooks=_getBooks(txt).then()
// console.log(serchedBooks)
// }

function getBooks(txt) {
  console.log('get ',txt,' ',`https://www.googleapis.com/books/v1/volumes?printType=books&q=${txt}`)
...
//   let fixedBook = {}
//   fixedBook.id = book.id
//   // console.log('fixed', fixedBook)
//   return fixedBook

function nextBook(){
  console.log('nextBookh')
}
